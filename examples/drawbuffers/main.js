( function () {
    ...
    Example.prototype = osg.objectInherit( ExampleOSGJS.prototype, {
        ...
        createRTTQuad: function ( width, height ) {
            ...
            stateSet.setAttributeAndModes( this.generateProgram() );
            return quad;
        },
        ...
        createScene: function () {
            ...
            var camera = this.createPreRenderCamera( this._canvas.width, this._canvas.height );
            ...
            for ( var i = 0; i < NUM_TEXTURES; i++ ) {
                this._textureList[ i ] = this.createColorTexture( this._canvas.width, this._canvas.height );
                this._textureList[ i ]._name = 'texturecolor' + i;
            }
            var depthTexture = this.createDephTexture( this._canvas.width, this._canvas.height );
